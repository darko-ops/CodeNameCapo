...
describe("parseExtraction", () => {
  it("parses a clean JSON object", () => {
    const e = parseExtraction('{"intent":"offer","offer_amount":12,"sentiment":"neutral","tactics":["lowball"]}');
    expect(e).toEqual({ intent: "offer", offer_amount: 12, sentiment: "neutral", tactics: ["lowball"] });
  });
  ...
  it("falls back to a no-number stall on garbage or invalid enums", () => {
    const fallback = { intent: "stall", offer_amount: null, sentiment: "neutral", tactics: [] };
